...
if __name__ == '__main__':
    ...
    with open('surf_mean_6h_2017_new_sim_0', 'rb') as fp:
        da_mean_2017 = pickle.load(fp).mean(axis=0)
    with open('surf_mean_6h_2018_new_sim_0', 'rb') as fp:
        da_mean_2018 = pickle.load(fp).mean(axis=0)
    with open('surf_mean_6h_2019_new_sim_0', 'rb') as fp:
        da_mean_2019 = pickle.load(fp).mean(axis=0)
    with open('surf_mean_6h_2020_new_sim_0', 'rb') as fp:
    ...
    add_plot_raw('SIM_SURF',da_mean_2017, da_mean_2018, da_mean_2019, da_mean_2020 ,files_2018[0], '',
