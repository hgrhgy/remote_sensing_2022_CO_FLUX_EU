...
if __name__ == '__main__':
    ...
    data_2017 = regrid('mopitt_surf_2017.png_data.pkl', 'mopitt_surf_2017.png_cnt.pkl',wrfin)
    data_2018 = regrid('mopitt_surf_2018.png_data.pkl', 'mopitt_surf_2018.png_cnt.pkl', wrfin)
    data_2019 = regrid('mopitt_surf_2019.png_data.pkl', 'mopitt_surf_2019.png_cnt.pkl', wrfin)
    data_2020 = regrid('mopitt_surf_2020.png_data.pkl', 'mopitt_surf_2020.png_cnt.pkl', wrfin)
    ...
    with open('mopitt_surf_2017', 'wb') as fp:
        pickle.dump(data_2017, fp)
    with open('mopitt_surf_2018', 'wb') as fp:
        pickle.dump(data_2018, fp)
    with open('mopitt_surf_2019', 'wb') as fp:
        pickle.dump(data_2019, fp)
    with open('mopitt_surf_2020', 'wb') as fp:
        pickle.dump(data_2020, fp)


    print(np.mean(data_2017),np.mean(data_2018),np.mean(data_2019),np.mean(data_2020))

    add_plot_raw('MOP_SURF', data_2017, data_2018, data_2019, data_2020, 'wrfinput_d01', '',
