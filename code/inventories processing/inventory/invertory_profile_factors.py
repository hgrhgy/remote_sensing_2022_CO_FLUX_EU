...
if __name__ == '__main__':
    ...
    print(
        'Country\tyear\tmonth\t1A1_GAS\t1A1_BIOMASS\t1A1_LIQUID\t1A1_SOLID\t1A1_OTHER\t1A2a\t1A2b\t1A2c\t1A2d\t1A2e'
        '\t1A2f\t1A2g\t1A3a\t1A3b\t1A3c\t1A3d\t1A3e\t1A4\t1B\t1C\t2A1\t2A2\t2A3\t2A4\t2B1\t2B2\t2B3\t2B4\t2B5\t2B6\t2B7\t2B8'
        '\t2B9\t2B10\t2C1\t2C2\t2C3\t2C4\t2C5\t2C6\t2C7\t2D1\t2D2\t2D3\t2D3\t2E1\t2E2\t2E3\t2E4\t2E5\t2F1\t2F2\t2F3'
        '\t2F4\t2F5\t2F6\t2G1\t2G2\t2G3\t2G4\t2H\t3\t4\t5\t6')
    for country in countries:
        ...
        for month in [12, 1, 2]:
            ...
            # 3 4 5 6
            sum_co += (emissions.co_3 + emissions.co_4 + emissions.co_5 + emissions.co_6) * profiles.get_other_coffs(
                code,
                month)

            dddd = (country, year, month,
                    # 1A1
                    coff_1a1['gas'], coff_1a1['biofuels'], coff_1a1['oil'], coff_1a1['coal'], coff_1a1['other'],
                    # 1A2
                    coff_1a2['1A2a'], coff_1a2['1A2b'], coff_1a2['1A2c'], coff_1a2['1A2d'], coff_1a2['1A2e'],
                    coff_1a2['1A2f'], coff_1a2['1A2g'],
                    # 1A3
                    coff_1a3['1A3a'], coff_1a3['1A3b'], coff_1a3['1A3c'],
                    coff_1a3['1A3d'], coff_1a3['1A3e'],
                    # 1A4
                    coff_1a4['1A4'],
                    # 1B
                    profiles.get_other_coffs(code, month),
                    # 1C
                    profiles.get_other_coffs(code, month),
                    # 2A
                    coff_2a['2A1'], coff_2a['2A2'], coff_2a['2A3'], coff_2a['2A4'],
                    # 2B
                    coff_2b['2B1'], coff_2b['2B2'], coff_2b['2B3'], coff_2b['2B4'], coff_2b['2B5'], coff_2b['2B6'],
                    coff_2b['2B7'], coff_2b['2B8'], coff_2b['2B9'], coff_2b['2B10'],
                    # 2C
                    coff_2c['2C1'], coff_2c['2C2'], coff_2c['2C3'], coff_2c['2C4'], coff_2c['2C5'], coff_2c['2C6'],
                    coff_2c['2C7'],
                    # 2D
                    coff_2d['2D1'], coff_2d['2D2'], coff_2d['2D3'],
                    # 2E
                    coff_2e['2E1'], coff_2e['2E2'], coff_2e['2E3'], coff_2e['2E4'], coff_2e['2E5'],
                    # 2F
                    coff_2f['2F1'], coff_2f['2F2'], coff_2f['2F3'], coff_2f['2F4'], coff_2f['2F5'], coff_2f['2F6'],
                    # 2G
                    coff_2g['2G1'], coff_2g['2G2'], coff_2g['2G3'], coff_2g['2G4'],
                    # 2H
                    profiles.get_other_coffs(code, month),
                    # 3
                    profiles.get_other_coffs(code, month),
            ...
            print('\t'.join([str(d) for d in dddd]))
        pass
